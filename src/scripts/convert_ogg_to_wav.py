...
if __name__ == "__main__":
  ...
  parser.add_argument("--dir", type=str, required=True, help="Directory to search for audio files.")
  parser.add_argument("--duration", type=float, required=False, help="Duration of audio to save clip the audio if needed.", default=-1)
